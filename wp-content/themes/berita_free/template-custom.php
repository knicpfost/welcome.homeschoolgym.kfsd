...
*/
    ...
    /* 
	    This is SITEMAP POST template displayed according to your 
		POST DISPLAY settings in theme options panel. You have option 
	...
	*/
	...
	foreach ($GLOBALS['opt']['bizzthemes_post_s'] as $key => $value) {
		...
		if ( $GLOBALS['opt']['bizzthemes_post_s_'.$key.''] == 'true' ) {
		    ...
		    if ($key == 'single') { $key = 'custom'; } // transform 'post' -> 'custom'
