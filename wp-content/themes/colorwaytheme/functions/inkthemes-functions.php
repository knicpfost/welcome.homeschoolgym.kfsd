...
wp_nav_menu(array('menu' => 'custom_menu', 'container_id' => 'menu', 'menu_class' => 'ddsmoothmenu', 'fallback_cb' => 'inkthemes_nav_fallback'));
else
...
function get_current_menu(){
		if ( is_home() ) {   print "<li class=\"current_page_item\">"; }
                   ...
                   if ( ! is_active_sidebar( 'primary-widget-area'  ) && ! is_active_sidebar( 'secondary-widget-area' )){ print "<li>"; }                   
                    else { }
		}}
...
print "<a href='$permalink'><img src='$homeLink/img_resize/timthumb.php?src=$first_img&w=250&h=160&zc=1' class='postimg wp-post-image' alt='$the_title' /></a>";
}
}
/*-----------------------------------------------------------------------------------*/
...
$output = get_option($shortname . 'colorway_analytics');
if ( $output <> "" ) 
